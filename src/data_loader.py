...
def get_mnist_loader(augment=True):
    """
    ...
    if augment:
        transform = transforms.Compose([
            transforms.ToTensor(),
            transforms.RandomRotation(degrees=10),      # Slight rotation (reduced from 15 to 10 degrees)
            ...
            transforms.GaussianBlur(
                ...
                sigma=(0.1, 0.2)                       # Random sigma for blur
            ),
